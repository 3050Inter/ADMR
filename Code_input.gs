...
const API_VERSION = 'v1.0.8-speed-employee-fix-20260707';
...
function saveEmployee(body) {
  ...
  const empSheet = ensureSheet(DB.sheets.employees, ['이름', '닉네임', '직급', '부서', '상태', '연락처', '보건증만료일', '현재누적', '메모', '입력시간']);
  ensureColumns(empSheet, ['이름', '닉네임', '직급', '부서', '상태', '연락처', '보건증만료일', '현재누적', '메모', '입력시간', '수정시간']);
